...
// Usa detección automática para túneles públicos, con fallback a variable de entorno
const API_BASE = import.meta.env.VITE_API_BASE_URL || `${getBackendUrl(8081)}/api`;
